...
public enum SemanticTokenType {
    ...
    WHILE, END_OF_WHILE, SWITCH, END_OF_SWITCH, BEGIN_ARGS, END_ARGS, ARG, NUM,INITIAL_VAR,INT_CREATEVAR,INITIALARRAY,INITIALPOINTER,PUSH,POP2,CREATEFUNCTION,DEFMAIN;
